...
<body style="background: rgb(228, 224, 224);">
   ...
   <div class="sidebar close">
    ...
    <h1 style="opacity: 60%;" class="text-center fw-bold mt-5 mb-5">Surat Masuk Konfirmasi</h1>
                ...
                <table  class="me-3 ms-3">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT * FROM konfirmasi_dosen ORDER BY id_kd DESC";
                            $query = mysqli_query($con, $sql);
                            while($siswa = mysqli_fetch_array($query)){
                                echo "<tr>";
                                echo "<td>"."<img src='./image/hijau.png' alt='kotak hijau' class='img-fluid mt-2'>"."</td>";
                                echo "<td>".$siswa['jenis_surat_kd']."</td>";
                                echo "<td class='text-end' style='margin-right:10%;'>";
                                echo "<a class='btn btn-primary ' href='surat-masuk.php?id=".$siswa['id_kd']."'>Lihat</a> | ";
                                echo "<a class='btn btn-warning ' href='proses-arsip-konfirmasi.php?id=".$siswa['id_kd']."'><i class='bx bx-archive-in' ></i></a> | ";
                                echo "<a class='btn btn-danger' href='hapus-kirim.php?id=".$siswa['id_kd']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                echo "</td>";
                                echo "</tr>";

                                echo "<tr>";
                                echo "<td>"."</td>";
                                echo "<td>".$siswa['tanggal_kd']."</td>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<td>"."<hr>"."</td>";
                                echo "<td>"."<hr>"."</td>";
        ...
        <div>
            <a class="btn btn-primary " style="margin-left: 90%;" href="buat-surat-dosen.php">Buat Surat</a>
        </div><br><br>
    </div>
