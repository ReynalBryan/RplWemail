        ...
        <form action="proses-pengajuan.php" method="POST">
            <div class="row">
                <div class="col-5">
                    ...
                    <input type="text" name="input_nim" placeholder="72190345" class="form-control" >
                </div>

                <div class="col-7" >
                    Nama Mahasiswa <br>
                    <input type="text" name="input_nama" placeholder="Joey Sapakoly" class="form-control"><br><br><br>
                </div>
            ...
            <div class="row">
                <div class="col-5">
                    ...
                    NIM Mahasiswa 2 <br>
                    <input type="text" name="input_nim2" placeholder="72190345" class="form-control" >
                    <span class="peringatan">*bila ada</span><br><br>
                </div>

                <div class="col-7" >
                    <br>  Nama Mahasiswa 2 <br>
                    <input type="text" name="input_nama2" placeholder="Joey Sapakoly" class="form-control">
            ...
            <div class="row">
                <div class="col-5">
                    NIM Mahasiswa 3 <br>
                    <input type="text" name="input_nim3" placeholder="72190345" class="form-control" >
                    <span class="peringatan">*bila ada</span><br><br>
                </div>

                <div class="col-7" >
                    Nama Mahasiswa 3 <br>
                    <input type="text" name="input_nama3" placeholder="Joey Sapakoly" class="form-control">
                    <span class="peringatan">*bila ada</span><br><br><br>
                </div>
            ...
            <div class="row">
                <div class="col-5">
                    NIM Mahasiswa 4 <br>
                    <input type="text" name="input_nim4" placeholder="72190345" class="form-control" >
                    <span class="peringatan">*bila ada</span><br><br>
                </div>

                <div class="col-7" >
                    Nama Mahasiswa 4 <br>
                    <input type="text" name="input_nama4" placeholder="Joey Sapakoly" class="form-control">
                    <span class="peringatan">*bila ada</span><br><br><br>
                </div>
            ...
            <div class="row">
                <div class="col-5">
                    NIM Mahasiswa 5 <br>
                    <input type="text" name="input_nim5" placeholder="72190345" class="form-control" >
                    <span class="peringatan">*bila ada</span><br><br>
                </div>

                <div class="col-7" >
                    Nama Mahasiswa 5 <br>
                    <input type="text" name="input_nama5" placeholder="Joey Sapakoly" class="form-control">
                    <span class="peringatan">*bila ada</span><br><br><br>
                </div>
                ...
                <div class="row">
                    <div class="col-6 ">
                        Email Mahasiswa <br>
                        <input type="text" name="input_email" placeholder="iniemailsaya@fti.ukdw.ac.id" class="form-control" ><br><br>
                    </div>
                    <div class="col-6">
                        Nomor Telepon Mahasiswa <br>
                        <input type="text" name="input_telp" placeholder="0812 3456 7789" class="form-control"><br><br>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <!-- <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item">Surat Manual</a></li>
                            <li><a class="dropdown-item" >Permohonan Surat Izin KP - A</a></li>
                            <li><a class="dropdown-item" >Surat Keterangan - A</a></li>
                            <li><a class="dropdown-item" >Surat Permohonan Keringanan Spp - B</a></li>
                            <li><a class="dropdown-item" >Surat Permohonan Beasiswa - B</a></li>
                            <li><a class="dropdown-item" >Surat Keterangan - B</a></li>
                        </ul>
                    </div><br> -->

                <div class="row-cols-1">
                    Tujuan Surat <br>
                <input type="text" name="tujuan" placeholder="Tujuan" class="form-control"> <br><br>
                
                Nama Mitra <br>
                <input type="text" name="nama_mitra" placeholder="Nama Mitra" class="form-control"> <br><br>

                Alamat Mitra <br>
                <input type="text" name="alamat_mitra" placeholder="Alamat Mitra" class="form-control"><br><br>
