...
<body style="background: rgb(228, 224, 224);">
    ...
    <!-- kotak masuk -->
    <div><br><br>
    <h1 style="opacity: 60%;" class="text-center fw-bold mt-5 mb-5">Surat Keluar</h1>
    <form action="urut.php" method="get">
        <div class="container hero2" >
            <div class="row">
                    ...
                    <table  class="me-2 ms-2">
                        ...
                        <tbody>
                            ...
                            include("../koneksi.php");
                                ...
                                $sql = "SELECT * FROM pengajuan_user ORDER BY id_pu DESC";
                                $query = mysqli_query($con, $sql);

                             
                                    while($siswa = mysqli_fetch_array($query)){
                                        echo "<tr>";
                                        echo "<td>".$siswa['jenis_surat_pu']."</td>";
                                        echo "<td class='text-end' style='margin-right:10%;'>";
                                        echo "<a class='btn btn-primary ' href='surat-masuk-pu.php?id=".$siswa['id_pu']."'>Lihat</a> | ";
                                        echo "<a class='btn btn-warning ' href='proses-arsip-pu.php?id=".$siswa['id_pu']."'><i class='bx bx-archive-in' ></i></a> | ";
                                        echo "<a class='btn btn-danger' href='hapus-surat-keluar.php?id=".$siswa['id_pu']."'><i class='bx bx-trash' ></i>Hapus</a>";
                                        echo "</td>";
                                        echo "</tr>";
    
                                        echo "<tr>";
                                        echo "<td>".$siswa['tanggal_pu']."</td>";
                                        echo "</tr>";
                                        echo "<tr>";
                                        echo "<td>"."<hr>"."</td>";
                                        echo "<td>"."<hr>"."</td>";
                ...
                <div>
                    <a class="btn btn-primary " style="margin-left: 88%;" href="buat-surat.php">Buat Surat</a><br><br>
                </div>
            </div>
        </div>
    </form>
