...
elseif(isset($_POST['ajukan'])){
    ...
    $sql = "INSERT INTO pengajuan_user (nama_pu, nim_pu, nama2_pu, nim2_pu, nama3_pu, nim3_pu, nama4_pu, nim4_pu, nama5_pu, nim5_pu, email_pu, telpon_pu, tujuan_pu, nama_mitra_pu, alamat_mitra_pu, keterangan_pu, jenis_surat_pu, tanggal_pu) 
    VALUE ('$nama', '$nim', '$nama2', '$nim2', '$nama3', '$nim3', '$nama4', '$nim4', '$nama5', '$nim5', '$email', '$telpon', '$tujuan', '$mitra', '$alamat', '$ket', '$jensu', '$tanggal')";
    $query = mysqli_query($con, $sql);
