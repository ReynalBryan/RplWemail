        ...
        <div class="hero1">
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="mb-8">
                    ...
                    <input type="input" placeholder="Nama Mahasiswa" value="<?php echo $siswa['nama'] ?>" name="input_nama" class="form-control" aria-describedby="emailHelp"><br>
                  </div>
                </div>
              </div> 
            ...
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="text-end">
                    <button type="submit" class="btn  btn-warning"  name="arsip_mhs">Arsipkan</button>
                </div>
