    ...
    <div class="container">
        <div class="hero1">
            ...
            <form action="konfirmasi.php" method="GET">
              <div class="row">
                <div class="col">
                  ...
                  <div style="color:red;" id="emailHelp" class="form-text">*Nim tidak dapat di ubah.</div><br>
                </div>
                <div class="col">
                  <div class="mb-8">
                    ...
                    <div style="color:red;" id="emailHelp" class="form-text">*Nama Mahasiswa tidak dapat di ubah.</div><br>
                  </div>
                </div>
              </div> 
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <div style="color:red;" id="emailHelp" class="form-text">*email Mahasiswa tidak dapat di ubah.</div>
                    </div><br>
                </div>
                <div class="col-4">
                    <div class="mb-8">
                        ...
                        <div style="color:red;" id="emailHelp" class="form-text">*nomor telepon tidak dapat di ubah.</div><br>
                    </div>
                </div>
              </div> 
              ...
              <button type="submit" class="btn btn6 btn-success"  name="konfirmasi">Konfirmasi</button>
