...
$sql = "SELECT * FROM pengajuan_dosen WHERE id_pd=$id";
    ...
    <div class="container">
        <div class="hero1">
            ...
            <div class="row">
                    ...
                    <div class="col-7" >
                        Nama Dosen <br>
                        <input type="text" name="input_nama" placeholder="Joey Sapakoly" value="<?php echo $siswa['nama_pd'] ?>" class="form-control">
                ...
                <div class="row">
                    <div class="col-6 ">
                        Email Dosen <br>
                        <input type="text" name="input_email" placeholder="iniemailsaya@fti.ukdw.ac.id" value="<?php echo $siswa['email_pd'] ?>" class="form-control" >
                        <span class="peringatan">*Email mahasiswa tidak dapat diubah</span><br><br>
                    </div>
                    <div class="col-6">
                        Nomor Telepon Dosen <br>
                        <input type="text" name="input_telp" placeholder="0812 3456 7789" value="<?php echo $siswa['telpon_pd'] ?>" class="form-control">
                ...
                <div class="row-cols-1">
                   Lokasi Kegiatan <br>
                    ...
                    <textarea name="keterangan" value="<?php echo $siswa['keterangan_pd'] ?>" cols="100" rows="10" class="form-control"><?php echo $siswa['keterangan_pd'] ?></textarea><br><br>
                ...
                <div class="col-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="pejabat"><br>
                            <option>Joey Sapakoly</option>
                            <option>Rafael Warokka</option>
                            <option>Reynal Pademme</option>
                        </select>
                    </div>
                </div>
            </div>
