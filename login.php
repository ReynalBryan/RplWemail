        ...
        if(!empty(trim($username)) && !empty(trim($password))){
            ...
            if ($rows === 1) {
                ...
                if(password_verify($password, $hash['password'])){
                    ...
                    $_SESSION['nama']= $hash['nama'];
             
                    $_SESSION['status'] = $hash['status'];
    
                    if($_SESSION['status'] == "Admin"){
                
                    header('location: admin/pengajuan-dosen.php');
                    exit;
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="login.php" method="POST">
                    ...
                    <div class="form-footer mt-2">
                        <p> Belum punya account? <a href="register.php">Register</a></p><br>
                        <p>*Mahasiswa Masuk Menggunakan NIM</p>
                        <p>*Dosen Masuk Menggunakan ID Dosen</p>
                        <p>*Admin Masuk Menggunakan nomor Admin</p>
                    </div>
                </form>
            </section>
            </section>
